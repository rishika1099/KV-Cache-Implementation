...
This folder contains the final-project artifacts uploaded to CourseWorks.
...
For repository structure, reproducibility instructions, and the W&B dashboard link, see the [top-level README](../README.md).
