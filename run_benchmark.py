"""
KV Cache Benchmark — Main Entry Point
Columbia University HPML Course

Usage:
  python run_benchmark.py
  python run_benchmark.py --methods baseline kivi snapkv
  python run_benchmark.py --seq_lens 512 2048
  python run_benchmark.py --dry_run           # 2 prompts per method, smoke test
  python run_benchmark.py --skip_longbench    # faster run without LongBench
  python run_benchmark.py --resume            # skip already-completed runs
  python run_benchmark.py --model facebook/opt-6.7b  # swap model without editing code
"""
...
def main():
    ...
    parser.add_argument('--methods', nargs='+',
                        choices=['baseline', 'kivi', 'xkv', 'snapkv', 'topk'],
    ...
    tqdm.write("TIP: Run inside tmux to survive SSH disconnection")
    tqdm.write("     tmux new -s benchmark && python run_benchmark.py")
